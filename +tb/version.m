...
ver.releasedate = 'May-19-2015';             % MM-DD-YYYY date of last stable release; present before 0.8.3 and kept for
                                             % backwards compatibility
ver.releasedatenum = datenum(2015, 05, 19);  % date number value for the date of last stable release; added in 0.8.3
